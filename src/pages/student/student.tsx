        ...
        <div className="min-h-screen bg-white font-sans text-neutral-900 pb-20">
            ...
            <div className="container mx-auto px-4 max-w-5xl -mt-16 relative z-10">
                ...
                <div className="flex flex-col md:flex-row items-center md:items-end gap-6 md:gap-8 mb-8 md:mb-12">
                    <div className="relative group shrink-0">
                        ...
                        >
                            ...
                            {user?.profile_url ? (
                                ...
                                <div className="w-full h-full flex items-center justify-center bg-black text-white text-4xl md:text-5xl font-bold">{user?.username?.[0]}</div>
                            )}
                            {isEditing && (
                    ...
                    <div className="flex-1 mb-0 md:mb-4 text-center md:text-left w-full md:w-auto">
                        <h1 className="text-3xl md:text-5xl font-black tracking-tighter text-black mb-3">{user?.name}</h1>
                        <div className="flex flex-wrap items-center justify-center md:justify-start gap-3 text-sm font-medium text-neutral-600">
                    ...
                    <div className="flex gap-3 mb-0 md:mb-4 shrink-0">
                        {isEditing ? (
                            <>
                            ...
                            <div className="space-y-16">
                                <div className="grid md:grid-cols-2 gap-6 md:gap-8">
                                    <button
                                        ...
                                        className="group relative overflow-hidden bg-white hover:bg-black rounded-[2rem] p-6 md:p-10 transition-all duration-300 border border-neutral-200 hover:border-black text-left disabled:opacity-50 disabled:cursor-not-allowed shadow-sm hover:shadow-2xl"
                                    >
                                        <div className="relative z-10 flex flex-col items-start h-full justify-between gap-6 md:gap-8">
                                            <div className="w-12 h-12 md:w-16 md:h-16 rounded-2xl bg-black text-white group-hover:bg-white group-hover:text-black flex items-center justify-center shadow-lg transition-colors duration-300">
                                                <Clock className="w-6 h-6 md:w-8 md:h-8" />
                                            </div>
                                            <div>
                                                <h3 className="text-2xl md:text-3xl font-black text-black group-hover:text-white mb-2 tracking-tight transition-colors">Request Outing</h3>
                                                <p className="font-medium text-sm md:text-base text-neutral-500 group-hover:text-neutral-400 transition-colors">Short duration leaves (few hours)</p>
                                            </div>
                                        </div>
                                    </button>
                                    <button
                                    ...
                                    >
                                        <div className="relative z-10 flex flex-col items-start h-full justify-between gap-6 md:gap-8">
                                            ...
                                            <div>
                                                <h3 className="text-2xl md:text-3xl font-black text-black group-hover:text-white mb-2 tracking-tight transition-colors">Request Outpass</h3>
                                                <p className="font-medium text-sm md:text-base text-neutral-500 group-hover:text-neutral-400 transition-colors">Long duration leaves (overnight/days)</p>
                                            </div>
                                        </div>
                                    </button>
                                </div>
